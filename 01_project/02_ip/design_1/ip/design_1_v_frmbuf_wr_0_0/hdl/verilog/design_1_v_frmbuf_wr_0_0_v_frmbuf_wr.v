...
(* CORE_GENERATION_INFO="design_1_v_frmbuf_wr_0_0_v_frmbuf_wr,hls_ip_2021_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu4ev-sfvc784-1-i,HLS_INPUT_CLOCK=3.323000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.425790,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=32,HLS_SYN_DSP=0,HLS_SYN_FF=7694,HLS_SYN_LUT=8593,HLS_VERSION=2021_2}" *)
...
reg   [31:0] frm_buffer2_read_reg_219;
reg   [31:0] frm_buffer_read_reg_224;
reg   [15:0] stride_read_reg_229;
wire   [11:0] empty_fu_188_p1;
reg   [11:0] empty_reg_234;
wire   [5:0] empty_73_fu_192_p1;
reg   [5:0] empty_73_reg_240;
wire   [11:0] empty_74_fu_196_p1;
reg   [11:0] empty_74_reg_245;
wire    ap_CS_fsm_state2;
reg   [2:0] colorFormat_reg_270;
wire   [14:0] grp_fu_213_p2;
reg   [14:0] WidthInBytes_reg_275;
...
wire   [31:0] zext_ln164_fu_200_p1;
wire   [11:0] grp_fu_213_p0;
wire   [2:0] grp_fu_213_p1;
reg   [4:0] ap_NS_fsm;
...
wire   [14:0] grp_fu_213_p00;
wire   [14:0] grp_fu_213_p10;
wire    ap_ce_reg;
...
design_1_v_frmbuf_wr_0_0_FrmbufWrHlsDataFlow grp_FrmbufWrHlsDataFlow_fu_160(
    ...
    .HwReg_frm_buffer(frm_buffer_read_reg_224),
    .HwReg_frm_buffer2(frm_buffer2_read_reg_219),
    .p_read(WidthInBytes_reg_275),
    .p_read1(colorFormat_reg_270),
    .p_read2(empty_reg_234),
    .p_read3(empty_74_reg_245),
    .p_read14(stride_read_reg_229),
    .p_read25(empty_73_reg_240),
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
mm_video_m_axi_U(
    ...
    .I_AWID(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWID),
    .I_AWLEN(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWLEN),
    .I_AWSIZE(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWSIZE),
    .I_AWLOCK(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWLOCK),
    .I_AWCACHE(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWCACHE),
    .I_AWQOS(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWQOS),
    .I_AWPROT(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWPROT),
    .I_AWUSER(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWUSER),
    .I_AWBURST(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWBURST),
    .I_AWREGION(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_AWREGION),
    .I_WVALID(mm_video_WVALID),
    .I_WREADY(mm_video_WREADY),
    .I_WDATA(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WDATA),
    .I_WID(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WID),
    .I_WUSER(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WUSER),
    .I_WLAST(grp_FrmbufWrHlsDataFlow_fu_160_m_axi_mm_video_WLAST),
...
design_1_v_frmbuf_wr_0_0_mul_12ns_3ns_15_2_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 12 ),
    .din1_WIDTH( 3 ),
    .dout_WIDTH( 15 ))
mul_12ns_3ns_15_2_1_U262(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .din0(grp_fu_213_p0),
    .din1(grp_fu_213_p1),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_state4) | ((1'b1 == ap_CS_fsm_state5) & (ap_sync_grp_FrmbufWrHlsDataFlow_fu_160_ap_ready == 1'b0)))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        WidthInBytes_reg_275 <= grp_fu_213_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state1)) begin
        empty_73_reg_240 <= empty_73_fu_192_p1;
        empty_74_reg_245 <= empty_74_fu_196_p1;
        empty_reg_234 <= empty_fu_188_p1;
        frm_buffer2_read_reg_219 <= frm_buffer2;
        frm_buffer_read_reg_224 <= frm_buffer;
        stride_read_reg_229 <= stride;
    end
end
...
assign BYTES_PER_PIXEL_address0 = zext_ln164_fu_200_p1;

assign MEMORY2LIVE_address0 = zext_ln164_fu_200_p1;
...
assign empty_73_fu_192_p1 = video_format[5:0];

assign empty_74_fu_196_p1 = height[11:0];

assign empty_fu_188_p1 = width[11:0];
...
assign grp_fu_213_p00 = empty_reg_234;

assign grp_fu_213_p1 = grp_fu_213_p10;

assign grp_fu_213_p10 = BYTES_PER_PIXEL_q0;

assign s_axis_video_TREADY = regslice_both_s_axis_video_V_data_V_U_ack_in;

assign zext_ln164_fu_200_p1 = video_format;
