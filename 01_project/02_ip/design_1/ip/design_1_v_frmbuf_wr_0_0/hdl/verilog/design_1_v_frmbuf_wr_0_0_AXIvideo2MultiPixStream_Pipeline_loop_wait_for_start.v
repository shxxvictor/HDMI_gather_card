...
always @ (*) begin
    if ((~((s_axis_video_TVALID == 1'b0) | (ap_start_int == 1'b0)) & (sof_fu_85_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign sof_fu_85_p1 = s_axis_video_TUSER;
